export const rolesYAgentes = [
	...
	},
	{
		...
		tarea:
			'Ser el primero en ingresar a la accion con sus habilidades de movimiento',
	},
	{
		rol: 'centinela',
		agentes: ['Killjoy', 'Cypher', 'Sage', 'Chamber'],
		tarea:
			'Vigilar los flancos y ralentizar a los enemigos con sus habilidades',
	},
];
...
export const valorantPoints = [
	{ cantidad: '500 VP', precio: 4 },
	{ cantidad: '1050 VP', precio: 8 },
	{ cantidad: '2175 VP', precio: 16 },
	{ cantidad: '5500 VP', precio: 40 },
	{ cantidad: '11500 VP', precio: 80 },
];
